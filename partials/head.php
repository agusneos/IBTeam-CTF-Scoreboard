  <head>
   ...
   <!--Font Awesome -->
   <link href="/IBTEAM-CTF/assets/css/font-awesome.min.css" rel="stylesheet">
   
    <!-- Bootstrap core CSS -->
    <link href="/IBTEAM-CTF/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="/IBTEAM-CTF/assets/css/style.css" rel="stylesheet">
